...
export default function Home() {
  return (
    <div style={{ position: 'relative', minHeight: '100vh' }}>
      ...
      <div className="pointer-events-none fixed inset-0 z-[1] bg-gradient-to-br from-[#0b0d12]/10 via-[#0e131d]/10 to-[#141928]/10" aria-hidden="true" />
          ...
          <div className="space-y-10">
            ...
            <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-12 items-start">
              <div className="space-y-6 max-w-3xl text-pretty">
                ...
                <div className="rounded-3xl border border-white/10 bg-[#0f121c] p-6 space-y-4">
                  <p className="text-lg text-white/100 break-words">
                    Étudiant en 3ᵉ année de BUT Informatique (IUT Annecy). Passionné par les technologies de l&rsquo;information, je suis enthousiaste à l&rsquo;idée
                    de mettre à profit mes compétences et ma créativité pour stimuler l&rsquo;innovation et contribuer à des solutions efficaces. Je suis
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link
                      href="/contact"
                      className="bg-emerald-400 text-black px-6 py-3 rounded-full font-semibold hover:bg-purple-700 hover:text-white transition"
                    >
                      Me contacter
                    </Link>
                    <a
              ...
              <div className="grid gap-6">
                {[
                  ...
                  <div key={item.label} className="rounded-3xl border border-white/10 bg-[#0f121c] p-6 text-pretty">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-[#0f121c] rounded-3xl p-6 border border-white/10 text-pretty">
